...
import type {
  ChainPilotExecutor,
  ChainPilotExecutorInterface,
} from "../../../../contracts/core/Executor.sol/ChainPilotExecutor";
...
type ChainPilotExecutorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ChainPilotExecutorConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ChainPilotExecutor__factory extends ContractFactory {
  constructor(...args: ChainPilotExecutorConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): ChainPilotExecutor__factory {
    return super.connect(runner) as ChainPilotExecutor__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ChainPilotExecutorInterface {
    return new Interface(_abi) as ChainPilotExecutorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ChainPilotExecutor {
    return new Contract(address, _abi, runner) as unknown as ChainPilotExecutor;
  }
}
