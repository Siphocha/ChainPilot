...
export interface ChainPilotExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approveTask"
      | "executeTask"
...
export interface ChainPilotExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): ChainPilotExecutor;
  waitForDeployment(): Promise<this>;

  interface: ChainPilotExecutorInterface;
